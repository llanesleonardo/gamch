      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row justify-center items-center gap-5 md:gap-20 border-b-1 md:border-b-4 border-white pb-8 mb-8 ">
          ...
          <div className="text-white">
            ...
            <p className="text-lg md:text-xl mb-4 text-center md:text-left">Grupo A Edades 3-6 años</p>
        ...
        <div className="flex flex-col md:flex-row justify-center items-center gap-5 md:gap-20   border-b-1 md:border-b-4 border-white pb-8 mb-8 hidden md:block ">
          <div className="text-white">
          ...
          <div>
           ...
           <div className="flex flex-col md:flex-row justify-center items-center gap-5 md:gap-20   border-b-1 md:border-b-4 border-white pb-8 mb-8 block md:hidden">
           <div>
            <Image
              src={
                "https://gamch.blob.core.windows.net/gamch/Img/Landing - VBS-20.png"
        ...
        <div className="flex flex-col md:flex-row justify-center items-center gap-5 md:gap-20  border-b-1 md:border-b-4 border-white pb-8 mb-8">
          ...
          <div className="text-white">
            ...
            <p className="text-lg md:text-xl mb-4 text-center md:text-left">Grupo C edades 13-17</p>
            <div className="flex flex-row justify-start items-center gap-10">
              <div className="flex flex-row justify-evenly items-center gap-10 mx-auto">
                <a href="mailto:gammy.ruiz@usw.salvationarmy.org">
                  {" "}
        ...
        <div className="flex flex-col md:flex-row justify-center items-center gap-5 md:gap-20    pb-8 mb-8 hidden md:block ">
          <div className="text-white">
            <h3 className="text-xl md:text-3xl text-center md:text-right">Jr Jiménez</h3>
            <p className="text-lg md:text-xl mb-4 text-center md:text-right">
              Encargado de los juegos y actividades
            </p>
            <div className="flex flex-row justify-end items-center gap-10">
              <div className="flex flex-row justify-evenly items-center gap-10 mx-auto">
                <a href="mailto:gammy.ruiz@usw.salvationarmy.org">
          ...
          <div>
            ...
            <div className="flex flex-col md:flex-row justify-center items-center gap-5 md:gap-20    pb-8 mb-8 block md:hidden">
           <div>
            <Image
              src={
                "https://gamch.blob.core.windows.net/gamch/Img/Landing - VBS-20.png"
